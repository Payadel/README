...
# 5. Remind user to update the version field in package
# 6. Tag a new release
...
#
# Usage: chmod +x release.sh; release.sh
#
# 
...
echo -e -n "Make sure the version field in your package (like package.json) is ${BOLD_BLUE}$new_tag${OFF}. Yes? [Y/${BOLD_UNDERLINED}n${OFF}] "
read -r YN
